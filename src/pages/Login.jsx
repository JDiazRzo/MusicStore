...
function Login() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-6s">
      ...
      <div className="bg-white/5 backdrop-blur-md border border-white/20 rounded-2xl p-8 w-full max-w-md shadow-lg z-10">
        ...
        <p className="text-white/50 text-sm text-center mt-4">
          ¿No tienes cuenta?{" "}
          <span onClick={() => navigate("/registro")} className="text-white cursor-pointer hover:underline">
            Regístrate
          </span>
        </p>
      </div>
